...
import gov.nasa.jpl.imce.omf.schema.tables.IRIScalarRestriction;
import gov.nasa.jpl.imce.omf.schema.tables.IRIScalarRestrictionHelper;
...
public class IRIScalarRestrictionEmptyTest {
    ...
    public void creationTest() {
        ...
        IRIScalarRestriction w1 = new IRIScalarRestriction(graphUUID, uuid, name, iri, restrictedRangeUUID);
