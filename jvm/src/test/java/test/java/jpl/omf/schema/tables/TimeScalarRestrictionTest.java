...
import gov.nasa.jpl.imce.omf.schema.tables.TimeScalarRestriction;
import gov.nasa.jpl.imce.omf.schema.tables.TimeScalarRestrictionHelper;
...
public class TimeScalarRestrictionTest {
    ...
    public void creationTest() {
        ...
        TimeScalarRestriction w1 = new TimeScalarRestriction(graphUUID, uuid, name, iri, restrictedRangeUUID)
