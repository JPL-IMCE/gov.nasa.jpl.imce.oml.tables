...
import gov.nasa.jpl.imce.omf.schema.tables.BinaryScalarRestriction;
import gov.nasa.jpl.imce.omf.schema.tables.BinaryScalarRestrictionHelper;
...
public class BinaryScalarRestrictionEmptyTest {
    ...
    public void creationTest() {
        ...
        BinaryScalarRestriction w1 = new BinaryScalarRestriction(graphUUID, uuid, name, iri, restrictedRangeUUID);
        ...
        String t1 = String.format(
                "{\"graphUUID\":\"%s\",\"uuid\":\"%s\",\"name\":\"%s\",\"iri\":\"%s\",\"length\":%s,\"maxLength\":%s,\"minLength\":%s,\"restrictedRangeUUID\":\"%s\"}",
                graphUUID, uuid, name, iri, ls, maxL, minL, restrictedRangeUUID);
