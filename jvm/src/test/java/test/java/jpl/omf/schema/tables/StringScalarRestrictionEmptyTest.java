...
import gov.nasa.jpl.imce.omf.schema.tables.StringScalarRestriction;
import gov.nasa.jpl.imce.omf.schema.tables.StringScalarRestrictionHelper;

public class StringScalarRestrictionEmptyTest {
    ...
    public void creationTest() {
        ...
        StringScalarRestriction w1 = new StringScalarRestriction(graphUUID, uuid, name, iri, restrictedRangeUUID);
