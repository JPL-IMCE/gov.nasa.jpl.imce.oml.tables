...
import gov.nasa.jpl.imce.oml.specification.tables.PlainLiteralScalarRestriction;
import gov.nasa.jpl.imce.oml.specification.tables.PlainLiteralScalarRestrictionHelper;
...
public class PlainLiteralScalarRestrictionTest {
    ...
    public void creationTest() {
        ...
        PlainLiteralScalarRestriction w1 = new PlainLiteralScalarRestriction(tboxUUID, uuid, name, restrictedRangeUUID)
                .withLength(5)
                .withMaxLength(50)
                .withMinLength(1)
                .withPattern("yyy")
        ...
        String t1 = String.format(
                ...
                tboxUUID, uuid, name, lan_s, ls, maxL, minL, ps, restrictedRangeUUID);
