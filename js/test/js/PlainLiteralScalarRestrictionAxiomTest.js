...
const w1 = PlainLiteralScalarRestrictionAxiomJS.jsPlainLiteralScalarRestrictionAxiom(
...
const s1 = OMF.gov.nasa.jpl.imce.omf.schema.tables.PlainLiteralScalarRestrictionAxiomHelper().toJSON(w1);
const r1 = OMF.gov.nasa.jpl.imce.omf.schema.tables.PlainLiteralScalarRestrictionAxiomHelper().fromJSON(s1);
...
console.log("Checking language...", w1.language === r1.language);
