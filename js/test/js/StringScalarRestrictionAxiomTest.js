...
const w1 = StringScalarRestrictionAxiomJS.jsStringScalarRestrictionAxiom(
...
const s1 = OMF.gov.nasa.jpl.imce.omf.schema.tables.StringScalarRestrictionAxiomHelper().toJSON(w1);
const r1 = OMF.gov.nasa.jpl.imce.omf.schema.tables.StringScalarRestrictionAxiomHelper().fromJSON(s1);
