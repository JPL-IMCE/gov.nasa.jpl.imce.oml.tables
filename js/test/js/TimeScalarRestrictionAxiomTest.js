...
const w1 = TimeScalarRestrictionAxiomJS.jsTimeScalarRestrictionAxiom(
...
const s1 = OMF.gov.nasa.jpl.imce.omf.schema.tables.TimeScalarRestrictionAxiomHelper().toJSON(w1);
const r1 = OMF.gov.nasa.jpl.imce.omf.schema.tables.TimeScalarRestrictionAxiomHelper().fromJSON(s1);
