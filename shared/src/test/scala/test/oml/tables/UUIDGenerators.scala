...
object UUIDGenerators {
  ...
  val extentUUID = uuid.map(id => taggedTypes.extentUUID(id.toString))
  val iriScalarRestrictionUUID = uuid.map(id => taggedTypes.iriScalarRestrictionUUID(id.toString))
  val literalBooleanUUID = uuid.map(id => taggedTypes.literalBooleanUUID(id.toString))
  val literalDateTimeUUID = uuid.map(id => taggedTypes.literalDateTimeUUID(id.toString))
  val literalDecimalUUID = uuid.map(id => taggedTypes.literalDecimalUUID(id.toString))
  val literalFloatUUID = uuid.map(id => taggedTypes.literalFloatUUID(id.toString))
  val literalNumberUUID = uuid.map(id => taggedTypes.literalNumberUUID(id.toString))
  val literalQuotedStringUUID = uuid.map(id => taggedTypes.literalQuotedStringUUID(id.toString))
  val literalRationalUUID = uuid.map(id => taggedTypes.literalRationalUUID(id.toString))
  val literalRawStringUUID = uuid.map(id => taggedTypes.literalRawStringUUID(id.toString))
  val literalRealUUID = uuid.map(id => taggedTypes.literalRealUUID(id.toString))
  val literalStringUUID = uuid.map(id => taggedTypes.literalStringUUID(id.toString))
  val literalURIUUID = uuid.map(id => taggedTypes.literalURIUUID(id.toString))
  val literalUUIDUUID = uuid.map(id => taggedTypes.literalUUIDUUID(id.toString))
  val literalValueUUID = uuid.map(id => taggedTypes.literalValueUUID(id.toString))
