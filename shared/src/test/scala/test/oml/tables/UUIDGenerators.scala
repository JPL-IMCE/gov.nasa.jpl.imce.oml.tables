...
object UUIDGenerators {
  ...
  val entityExistentialForwardReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityExistentialForwardReifiedRestrictionAxiomUUID(id.toString))
  val entityExistentialInverseReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityExistentialInverseReifiedRestrictionAxiomUUID(id.toString))
  val entityExistentialRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityExistentialRestrictionAxiomUUID(id.toString))
  val entityExistentialUnreifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityExistentialUnreifiedRestrictionAxiomUUID(id.toString))
  val entityForwardReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityForwardReifiedRestrictionAxiomUUID(id.toString))
  val entityInverseReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityInverseReifiedRestrictionAxiomUUID(id.toString))
  val entityReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityReifiedRestrictionAxiomUUID(id.toString))
  ...
  val entityUniversalForwardReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityUniversalForwardReifiedRestrictionAxiomUUID(id.toString))
  val entityUniversalInverseReifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityUniversalInverseReifiedRestrictionAxiomUUID(id.toString))
  val entityUniversalRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityUniversalRestrictionAxiomUUID(id.toString))
  val entityUniversalUnreifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityUniversalUnreifiedRestrictionAxiomUUID(id.toString))
  val entityUnreifiedRestrictionAxiomUUID = uuid.map(id => taggedTypes.entityUnreifiedRestrictionAxiomUUID(id.toString))
