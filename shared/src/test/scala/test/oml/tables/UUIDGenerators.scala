...
object UUIDGenerators {
  ...
  val aspectKindUUID = uuid.map(id => taggedTypes.aspectKindUUID(id.toString))
  ...
  val cardinalityRestrictedAspectUUID = uuid.map(id => taggedTypes.cardinalityRestrictedAspectUUID(id.toString))
  val cardinalityRestrictedConceptUUID = uuid.map(id => taggedTypes.cardinalityRestrictedConceptUUID(id.toString))
  val cardinalityRestrictedReifiedRelationshipUUID = uuid.map(id => taggedTypes.cardinalityRestrictedReifiedRelationshipUUID(id.toString))
  val chainRuleUUID = uuid.map(id => taggedTypes.chainRuleUUID(id.toString))
  val characterizedEntityRelationshipUUID = uuid.map(id => taggedTypes.characterizedEntityRelationshipUUID(id.toString))
  ...
  val conceptKindUUID = uuid.map(id => taggedTypes.conceptKindUUID(id.toString))
  ...
  val conceptualRelationshipUUID = uuid.map(id => taggedTypes.conceptualRelationshipUUID(id.toString))
  ...
  val forwardPropertyUUID = uuid.map(id => taggedTypes.forwardPropertyUUID(id.toString))
  ...
  val instanceRelationshipEnumerationRestrictionUUID = uuid.map(id => taggedTypes.instanceRelationshipEnumerationRestrictionUUID(id.toString))
  val instanceRelationshipExistentialRangeRestrictionUUID = uuid.map(id => taggedTypes.instanceRelationshipExistentialRangeRestrictionUUID(id.toString))
  val instanceRelationshipOneOfRestrictionUUID = uuid.map(id => taggedTypes.instanceRelationshipOneOfRestrictionUUID(id.toString))
  val instanceRelationshipUniversalRangeRestrictionUUID = uuid.map(id => taggedTypes.instanceRelationshipUniversalRangeRestrictionUUID(id.toString))
  val instanceRelationshipValueRestrictionUUID = uuid.map(id => taggedTypes.instanceRelationshipValueRestrictionUUID(id.toString))
  val intrinsicIdentityKindUUID = uuid.map(id => taggedTypes.intrinsicIdentityKindUUID(id.toString))
  val inversePropertyUUID = uuid.map(id => taggedTypes.inversePropertyUUID(id.toString))
  ...
  val predicateUUID = uuid.map(id => taggedTypes.predicateUUID(id.toString))
  ...
  val reifiedRelationshipRestrictionUUID = uuid.map(id => taggedTypes.reifiedRelationshipRestrictionUUID(id.toString))
  ...
  val restrictableRelationshipUUID = uuid.map(id => taggedTypes.restrictableRelationshipUUID(id.toString))
