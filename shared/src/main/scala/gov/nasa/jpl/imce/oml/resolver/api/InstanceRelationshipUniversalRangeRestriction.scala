...
/*
 * An OML InstanceRelationshipUniversalRangeRestriction specifies an OWL ObjectSomeValuesFrom
 ...
 */
trait InstanceRelationshipUniversalRangeRestriction
  extends TerminologyInstanceAssertion
  with ElementCrossReferenceTuple
{
  override val uuid: taggedTypes.InstanceRelationshipUniversalRangeRestrictionUUID
...
object InstanceRelationshipUniversalRangeRestriction {

  def descriptionBox
  (i: InstanceRelationshipUniversalRangeRestriction, ext: Extent)
