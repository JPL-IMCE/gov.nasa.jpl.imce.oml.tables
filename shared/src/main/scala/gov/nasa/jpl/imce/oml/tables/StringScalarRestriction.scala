...
@JSExportTopLevel("StringScalarRestrictionHelper")
object StringScalarRestrictionHelper {
  ...
  implicit val decodeStringScalarRestriction: Decoder[StringScalarRestriction]
  = Decoder.instance[StringScalarRestriction] { c: HCursor =>
    
    import cats.syntax.either._
  
    for {
    	  uuid <- c.downField("uuid").as[taggedTypes.StringScalarRestrictionUUID]
  ...
  implicit val encodeStringScalarRestriction: Encoder[StringScalarRestriction]
  = new Encoder[StringScalarRestriction] {
    override final def apply(x: StringScalarRestriction): Json 
    = Json.obj(
    	  ("uuid", taggedTypes.encodeStringScalarRestrictionUUID(x.uuid)),
  ...
  : String
  = encodeStringScalarRestriction(c).noSpaces
  ...
  = parse(c) match {
  	case scala.Right(json) =>
  	  decodeStringScalarRestriction(json.hcursor) match {
