...
(
  @(JSExport @field) override val uuid: taggedTypes.ScalarDataPropertyUUID,
...
) extends DataRelationship with DataRelationshipFromStructure with DataRelationshipToScalar {
