...
object ReifiedRelationshipInversePropertyPredicateHelper {
  ...
  implicit val w
  : upickle.default.Writer[ReifiedRelationshipInversePropertyPredicate]
  = upickle.default.macroW[ReifiedRelationshipInversePropertyPredicate]
  ...
  implicit val r
  : upickle.default.Reader[ReifiedRelationshipInversePropertyPredicate]
  = upickle.default.macroR[ReifiedRelationshipInversePropertyPredicate]

  @JSExport
  def fromJSON(c: String)
  : ReifiedRelationshipInversePropertyPredicate
  = upickle.default.read[ReifiedRelationshipInversePropertyPredicate](c)
